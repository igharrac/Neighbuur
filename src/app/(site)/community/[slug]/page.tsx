      ...
      <div className="max-w-[800px] mx-auto px-6 py-8">
        ...
        <div className="flex flex-col gap-6">
          {overigeBlokken.length === 0 ? (
            <p className="text-body-sm text-warmgrijs">Deze community-pagina heeft nog geen content.</p>
          ) : (
            overigeBlokken.map((blok) => (
              <div key={blok.id} className="bg-white rounded-md shadow-soft p-6 md:p-8">
