...
export default async function AdminBewonersPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10">
      <h1 className="font-display text-display-sm text-warmzwart mb-6">Bewoners</h1>
      <AdminAccountList kind="resident" />
    </div>
  );
}
