...
export function InvullenVoorPublicatie({ children }: { children: React.ReactNode }) {
  return (
    <div className="rounded-md border-2 border-dashed border-sage bg-sage-50 p-4">
      <p className="text-body-xs font-bold uppercase tracking-wider text-sage mb-1.5">
