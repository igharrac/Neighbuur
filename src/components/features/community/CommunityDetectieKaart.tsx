...
import { Users, Sparkle, ArrowRight } from "@phosphor-icons/react";
...
export function CommunityDetectieKaart(props: DetectieResultaat) {
  ...
  async function start() {
    ...
    setSaving(false);
    const resultaat = data?.[0] as { slug: string } | undefined;
  ...
  return (
    <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-[0px_4px_10px_rgba(92,64,40,0.04)] flex items-center gap-3">
      <span className="w-10 h-10 rounded-full bg-terracotta-50 flex items-center justify-center shrink-0">
